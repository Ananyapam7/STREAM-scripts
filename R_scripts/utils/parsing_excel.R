...
parse_last_attempt_sheet <- function(filepath) {
  ...
  last_attempt_data <- map(last_attempt_sheets, ~parse_excel_bubble(filepath, .x))
...
# Example usage
#result <- parse_all_sheets("/home/ananyapam/Projects/STREAM/data/START_sample_data/child_729_survey_1205_results_1542330763/child_id_survey_1205_motoric_following_results_1542330762.xlsx")
result <- parse_last_attempt_sheet("/home/ananyapam/Projects/STREAM/data/START_sample_data/child_729_survey_1205_results_1542330763/child_id_survey_1205_motoric_following_results_1542330762.xlsx")